...
const RatingItem = ({
  ...
  const shouldShowFilled = currentValue >= point;
  ...
  return (
    <>
      ...
      >
        {!shouldShowFilled && icons.emptyIcon}
        {shouldShowFilled && !isPartialPoint && icons.fullIcon}
        {shouldShowFilled && isPartialPoint && (
          <div className="relative">
            {icons.emptyIcon}
            <div className="absolute inset-0 overflow-hidden" style={{ width: partialPointWidth }}>
              {icons.fullIcon}
            </div>
          </div>
        )}
