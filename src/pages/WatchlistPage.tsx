...
const WatchlistPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>My Watchlist - VFlix Streaming</title>
        <meta name="description" content="View and manage your personal watchlist. Keep track of movies and TV shows you want to watch on VFlix." />
        ...
        <meta name="twitter:description" content="View and manage your personal watchlist. Keep track of movies and TV shows you want to watch on VFlix." />
                  ...
                  <div key={item.id} className="relative group">
                    <MediaCard
                      ...
                      className={cn(
                        ...
                        item.watched && "ring-2 ring-green-500/50"
                      )}
                    />
                  </div>
                ))}
