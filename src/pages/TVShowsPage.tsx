...
const TVShowsPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>TV Shows - VFlix Streaming</title>
        <meta name="description" content="Browse popular, trending, and top-rated TV shows. Discover new series and manage your watchlist on VFlix." />
        <meta property="og:title" content="TV Shows - VFlix Streaming" />
        <meta property="og:description" content="Browse popular, trending, and top-rated TV shows. Discover new series and manage your watchlist on VFlix." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://vflix-mocha.vercel.app/tv" />
        <meta property="og:image" content="/favicon.svg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="TV Shows - VFlix Streaming" />
        <meta name="twitter:description" content="Browse popular, trending, and top-rated TV shows. Discover new series and manage your watchlist on VFlix." />
