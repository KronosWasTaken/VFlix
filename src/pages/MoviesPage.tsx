...
const MoviesPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Movies - VFlix Streaming</title>
        <meta name="description" content="Browse popular, trending, and top-rated movies. Discover new films and manage your watchlist on VFlix." />
        ...
        <meta name="twitter:description" content="Browse popular, trending, and top-rated movies. Discover new films and manage your watchlist on VFlix." />
